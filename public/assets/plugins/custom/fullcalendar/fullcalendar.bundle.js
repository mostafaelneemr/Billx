...
(function (global, factory) {
    ...
    */
    ...
    function isInteractionPropsValid(state, calendar, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            // allow (a function)
            var calendarEventStore = calendar.state.eventStore; // need global-to-calendar, not local to list_summary (splittable)state
    ...
    */
    ...
    var Component = /** @class */ (function () {
        ...
        // after destroy is called, this list_summary won't ever be used again
    ...
    */
    var DateComponent = /** @class */ (function (_super) {
        ...
        DateComponent.prototype.isValidSegDownEl = function (el) {
            ...
            // ^above line ensures we don't detect a seg interaction within a nested list_summary.
            // it's a HACK because it only supports a popover as the nested list_summary.
        };
    ...
    */
    ...
    enters/leaves event-elements of a list_summary.
    */
    var EventHovering = /** @class */ (function (_super) {
        ...
        function EventHovering(settings) {
            ...
            // how to make sure list_summary already has context?
    ...
    */
    ...
    var Slicer = /** @class */ (function () {
        ...
        /*
        "complete" seg means it has list_summary and eventRange
        */
...
(function (global, factory) {
    ...
    */
    ...
    var AbstractDayGridView = /** @class */ (function (_super) {
        ...
        // The day-grid list_summary will render inside of a container defined by this HTML.
        ...
        // Sets the height of just the DayGrid list_summary in this view
...
(function (global, factory) {
    ...
    */
    ...
    /*
    Monitors when the user clicks on a specific date/time of a list_summary.
    ...
    */
    ...
    /*
    Tracks when the user selects a portion of time of a list_summary,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // don't bother to watch expensive moves if list_summary won't do selection
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var dropArg = __assign({}, receivingCalendar.buildDatePointApi(finalHit.dateSpan), { draggedEl: ev.subjectEl, jsEvent: ev.origEvent, view: finalHit.component // should this be finalHit.list_summary.view? See #4644
                             });
                            ...
                            receivingCalendar.publiclyTrigger('eventReceive', [
                                {
                                    ...
                                    view: finalHit.component // should this be finalHit.list_summary.view? See #4644
                                }
                            ]);
                        }
                    }
    ...
    */
    var ExternalElementDragging = /** @class */ (function () {
        function ExternalElementDragging(dragging, suppliedDragMeta) {
            ...
            hitDragging.requireInitial = false; // will start outside of a list_summary
...
(function (global, factory) {
    ...
    */
    ...
    /* A list_summary that renders one or more columns of vertical time slots
    ----------------------------------------------------------------------------------------------------------------------*/
